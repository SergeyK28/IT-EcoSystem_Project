...
class Ui_Ui_Remont_Console_Dialog(object):
    def setupUi(self, Ui_Remont_Console_Dialog):
        self.dialog = Ui_Remont_Console_Dialog

        Ui_Remont_Console_Dialog.setObjectName("Ui_Remont_Console_Dialog")
        Ui_Remont_Console_Dialog.resize(1100, 950)
        Ui_Remont_Console_Dialog.setMinimumSize(1000, 800)

        font = QFont("Segoe UI", 10)
        Ui_Remont_Console_Dialog.setFont(font)

        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../Pictures/Screenshot from 2025-09-15 14-30-16.png"),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Ui_Remont_Console_Dialog.setWindowIcon(icon)

        Ui_Remont_Console_Dialog.setStyleSheet("""
            QDialog {
        ...
        self.main_layout = QtWidgets.QVBoxLayout(Ui_Remont_Console_Dialog)
        ...
        self.page_title = QLabel("🎮 Ремонт игровых приставок")
        ...
        self.QW_Remont_console = QWidget()
        self.QW_Remont_console.setStyleSheet("background-color: transparent;")
        self.gridLayout = QtWidgets.QGridLayout(self.QW_Remont_console)
        ...
        self.LB1_Remont_console = QLabel()
        self.LB1_Remont_console.setWordWrap(True)
        self.LB1_Remont_console.setOpenExternalLinks(True)
        self.LB1_Remont_console.setStyleSheet("""
            QLabel {
                color: #f0f0f0;
        ...
        """)
        info_layout.addWidget(self.LB1_Remont_console)
        ...
        table_header = QLabel("💰 Стоимость ремонта игровых приставок")
        ...
        services_list = [
            {"name": "Ремонт блока питания", "price": "от 1200 ₽"},
            {"name": "Замена HDMI порта", "price": "от 900 ₽"},
            {"name": "Ремонт материнской платы", "price": "от 1800 ₽"},
            {"name": "Замена оптического привода", "price": "от 1500 ₽"},
            {"name": "Ремонт системы охлаждения", "price": "от 1000 ₽"},
            {"name": "Замена термопасты", "price": "от 600 ₽"},
            {"name": "Ремонт джойстиков/геймпадов", "price": "от 800 ₽"},
            {"name": "Прошивка ПО", "price": "от 700 ₽"}
        ]
        ...
        self.order_button = ModernButton("🎮 Заказать ремонт игровой приставки")
        ...
        self.LB2_Remont_console = QLabel()
        self.LB2_Remont_console.setWordWrap(True)
        self.LB2_Remont_console.setOpenExternalLinks(True)
        self.LB2_Remont_console.setStyleSheet("""
            QLabel {
                color: #e0e0e0;
                background: transparent;
                font-size: 15px;
        ...
        """)
        detail_layout.addWidget(self.LB2_Remont_console)
        ...
        self.scrollArea.setWidget(self.QW_Remont_console)
        self.main_layout.addWidget(self.scrollArea)

        self.back_button.clicked.connect(Ui_Remont_Console_Dialog.close)

        self.setup_favorites_button()
        self.check_favorite_status()

        self.retranslateUi(Ui_Remont_Console_Dialog)
        QtCore.QMetaObject.connectSlotsByName(Ui_Remont_Console_Dialog)

    def retranslateUi(self, Ui_Remont_Console_Dialog):
        _translate = QtCore.QCoreApplication.translate
        Ui_Remont_Console_Dialog.setWindowTitle(_translate("Ui_Remont_Console_Dialog", "IT-EcoSystem - Ремонт игровых приставок"))

        lb1_text = """
        <div style='text-align: left;'>
            <h1 style='color: #4CAF50; font-size: 32px; margin: 0 0 20px 0;'>🎮 Ремонт игровых приставок</h1>
            <p style='font-size: 16px; margin-bottom: 20px; color: #e0e0e0;'>
                ...
                игровых приставок всех поколений.
            </p>
            <div style='background-color: rgba(76, 175, 80, 0.1); border-left: 4px solid #4CAF50; padding: 15px; margin: 20px 0; border-radius: 0 10px 10px 0;'>
                <p style='margin: 0; font-size: 15px;'>
                    <span style='color: #4CAF50; font-weight: bold;'>✓ Ремонт любых консолей</span><br>
                    <span style='color: #b0b0b0;'>Ремонтируем PlayStation, Xbox, Nintendo Switch и другие консоли</span>
                </p>
            </div>
            <p style='font-size: 15px; margin: 15px 0; color: #d0d0d0;'>
                <b style='color: #4CAF50;'>Мы ремонтируем:</b> PlayStation 4/5, Xbox One/Series X|S, Nintendo Switch, Retro консоли
            </p>
        </div>
        """
        self.LB1_Remont_console.setText(_translate("Ui_Remont_Console_Dialog", lb1_text))
        ...
        <div>
            ...
            <div style='margin: 20px 0;'>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>🎮 PlayStation</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Ремонт PS4, PS4 Pro, PS5: замена термопасты, чистка, ремонт блока питания, замена дисковода</p>
                </div>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>🕹️ Xbox</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Ремонт Xbox One, Xbox Series X/S: решение проблем с питанием, перегревом, HDMI портами</p>
                </div>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>🔫 Nintendo Switch</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Ремонт джойконов (дрифт), замена экрана, ремонт консоли, восстановление аккумулятора</p>
                </div>
            </div>
        ...
        """
        self.LB2_Remont_console.setText(_translate("Ui_Remont_Console_Dialog", lb2_text))
...
if __name__ == "__main__":
    ...
    ui = Ui_Ui_Remont_Console_Dialog()
    ui.setupUi(Dialog)
    Dialog.show()
    sys.exit(app.exec_())