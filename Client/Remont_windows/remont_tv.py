...
class Ui_Ui_Remont_TV_Dialog(object):
    def setupUi(self, Ui_Remont_TV_Dialog):
        self.dialog = Ui_Remont_TV_Dialog

        Ui_Remont_TV_Dialog.setObjectName("Ui_Remont_TV_Dialog")
        Ui_Remont_TV_Dialog.resize(1100, 950)
        Ui_Remont_TV_Dialog.setMinimumSize(1000, 800)

        font = QFont("Segoe UI", 10)
        Ui_Remont_TV_Dialog.setFont(font)

        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../Pictures/Screenshot from 2025-09-15 14-30-16.png"),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Ui_Remont_TV_Dialog.setWindowIcon(icon)

        Ui_Remont_TV_Dialog.setStyleSheet("""
            QDialog {
        ...
        self.main_layout = QtWidgets.QVBoxLayout(Ui_Remont_TV_Dialog)
        ...
        self.page_title = QLabel("📺 Ремонт телевизоров")
        ...
        self.QW_Remont_tv = QWidget()
        self.QW_Remont_tv.setStyleSheet("background-color: transparent;")
        self.gridLayout = QtWidgets.QGridLayout(self.QW_Remont_tv)
        ...
        self.LB1_Remont_tv = QLabel()
        self.LB1_Remont_tv.setWordWrap(True)
        self.LB1_Remont_tv.setOpenExternalLinks(True)
        self.LB1_Remont_tv.setStyleSheet("""
            QLabel {
                color: #f0f0f0;
        ...
        """)
        info_layout.addWidget(self.LB1_Remont_tv)
        ...
        table_header = QLabel("💰 Стоимость ремонта телевизоров")
        ...
        services_list = [
            {"name": "Замена матрицы (экрана)", "price": "от 3000 ₽"},
            {"name": "Ремонт блока питания", "price": "от 1500 ₽"},
            {"name": "Замена подсветки LED", "price": "от 2000 ₽"},
            {"name": "Ремонт материнской платы", "price": "от 1800 ₽"},
            {"name": "Замена T-Con платы", "price": "от 1200 ₽"},
            {"name": "Ремонт Main Board", "price": "от 2000 ₽"},
            {"name": "Замена инвертора", "price": "от 1000 ₽"},
        ...
        self.order_button = ModernButton("📺 Заказать ремонт телевизора")
        ...
        self.LB2_Remont_tv = QLabel()
        self.LB2_Remont_tv.setWordWrap(True)
        self.LB2_Remont_tv.setOpenExternalLinks(True)
        self.LB2_Remont_tv.setStyleSheet("""
            QLabel {
                color: #e0e0e0;
                background: transparent;
                font-size: 15px;
        ...
        """)
        detail_layout.addWidget(self.LB2_Remont_tv)
        ...
        self.scrollArea.setWidget(self.QW_Remont_tv)
        self.main_layout.addWidget(self.scrollArea)

        self.back_button.clicked.connect(Ui_Remont_TV_Dialog.close)

        self.setup_favorites_button()
        self.check_favorite_status()

        self.retranslateUi(Ui_Remont_TV_Dialog)
        QtCore.QMetaObject.connectSlotsByName(Ui_Remont_TV_Dialog)

    def retranslateUi(self, Ui_Remont_TV_Dialog):
        _translate = QtCore.QCoreApplication.translate
        Ui_Remont_TV_Dialog.setWindowTitle(_translate("Ui_Remont_TV_Dialog", "IT-EcoSystem - Ремонт телевизоров"))

        lb1_text = """
        <div style='text-align: left;'>
            <h1 style='color: #4CAF50; font-size: 32px; margin: 0 0 20px 0;'>📺 Ремонт телевизоров любой сложности</h1>
            <p style='font-size: 16px; margin-bottom: 20px; color: #e0e0e0;'>
                ...
                телевизоров всех марок и моделей.
            </p>
            <div style='background-color: rgba(76, 175, 80, 0.1); border-left: 4px solid #4CAF50; padding: 15px; margin: 20px 0; border-radius: 0 10px 10px 0;'>
                <p style='margin: 0; font-size: 15px;'>
                    <span style='color: #4CAF50; font-weight: bold;'>✓ Ремонт любых телевизоров</span><br>
                    <span style='color: #b0b0b0;'>Ремонтируем LED, OLED, QLED, LCD, Plasma телевизоры</span>
                </p>
            </div>
            <p style='font-size: 15px; margin: 15px 0; color: #d0d0d0;'>
                <b style='color: #4CAF50;'>Мы ремонтируем:</b> Samsung, LG, Sony, Philips, Panasonic, TCL, Xiaomi, Hisense и другие бренды
            </p>
        </div>
        """
        self.LB1_Remont_tv.setText(_translate("Ui_Remont_TV_Dialog", lb1_text))
        ...
        <div>
            ...
            <div style='margin: 20px 0;'>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>🖥️ Ремонт матрицы</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Замена битых пикселей, восстановление подсветки, замена поляризационных пленок</p>
                </div>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>⚡ Ремонт электроники</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Восстановление блоков питания, материнских плат, T-Con плат</p>
                </div>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>📡 SMART TV</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Настройка Smart TV, обновление прошивки, восстановление Wi-Fi модуля</p>
                </div>
            </div>
        ...
        """
        self.LB2_Remont_tv.setText(_translate("Ui_Remont_TV_Dialog", lb2_text))
