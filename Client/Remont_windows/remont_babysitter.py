...
class Ui_Ui_Remont_Babysitter_Dialog(object):
    def setupUi(self, Ui_Remont_Babysitter_Dialog):
        self.dialog = Ui_Remont_Babysitter_Dialog

        Ui_Remont_Babysitter_Dialog.setObjectName("Ui_Remont_Babysitter_Dialog")
        Ui_Remont_Babysitter_Dialog.resize(1100, 950)
        Ui_Remont_Babysitter_Dialog.setMinimumSize(1000, 800)

        font = QFont("Segoe UI", 10)
        Ui_Remont_Babysitter_Dialog.setFont(font)

        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../Pictures/Screenshot from 2025-09-15 14-30-16.png"),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Ui_Remont_Babysitter_Dialog.setWindowIcon(icon)

        Ui_Remont_Babysitter_Dialog.setStyleSheet("""
            QDialog {
        ...
        self.main_layout = QtWidgets.QVBoxLayout(Ui_Remont_Babysitter_Dialog)
        ...
        self.page_title = QLabel("👶 Ремонт видеонянь")
        ...
        self.page_subtitle = QLabel("Профессиональный ремонт видеонянь")
        ...
        self.QW_Remont_babysitter = QWidget()
        self.QW_Remont_babysitter.setStyleSheet("background-color: transparent;")
        self.gridLayout = QtWidgets.QGridLayout(self.QW_Remont_babysitter)
        ...
        self.LB1_Remont_babysitter = QLabel()
        self.LB1_Remont_babysitter.setWordWrap(True)
        self.LB1_Remont_babysitter.setOpenExternalLinks(True)
        self.LB1_Remont_babysitter.setStyleSheet("""
            QLabel {
                color: #f0f0f0;
        ...
        """)
        info_layout.addWidget(self.LB1_Remont_babysitter)
        ...
        table_header = QLabel("💰 Стоимость ремонта видеонянь")
        ...
        services_list = [
            {"name": "Ремонт родительского блока", "price": "от 1000 ₽"},
            {"name": "Ремонт детского блока", "price": "от 1200 ₽"},
            {"name": "Замена аккумулятора", "price": "от 800 ₽"},
            {"name": "Ремонт экрана", "price": "от 900 ₽"},
            {"name": "Восстановление связи", "price": "от 700 ₽"},
            {"name": "Замена динамика/микрофона", "price": "от 600 ₽"},
            {"name": "Ремонт разъема питания", "price": "от 500 ₽"},
            {"name": "Диагностика", "price": "от 400 ₽"}
        ]
        ...
        self.order_button = ModernButton("👶 Заказать ремонт видеоняни")
        ...
        self.LB2_Remont_babysitter = QLabel()
        self.LB2_Remont_babysitter.setWordWrap(True)
        self.LB2_Remont_babysitter.setOpenExternalLinks(True)
        self.LB2_Remont_babysitter.setStyleSheet("""
            QLabel {
                color: #e0e0e0;
                background: transparent;
                font-size: 15px;
        ...
        """)
        detail_layout.addWidget(self.LB2_Remont_babysitter)
        ...
        self.scrollArea.setWidget(self.QW_Remont_babysitter)
        self.main_layout.addWidget(self.scrollArea)

        self.back_button.clicked.connect(Ui_Remont_Babysitter_Dialog.close)

        self.setup_favorites_button()
        self.check_favorite_status()

        self.retranslateUi(Ui_Remont_Babysitter_Dialog)
        QtCore.QMetaObject.connectSlotsByName(Ui_Remont_Babysitter_Dialog)

    def retranslateUi(self, Ui_Remont_Babysitter_Dialog):
        _translate = QtCore.QCoreApplication.translate
        Ui_Remont_Babysitter_Dialog.setWindowTitle(_translate("Ui_Remont_Babysitter_Dialog", "IT-EcoSystem - Ремонт видеонянь"))

        lb1_text = """
        <div style='text-align: left;'>
            <h1 style='color: #4CAF50; font-size: 32px; margin: 0 0 20px 0;'>👶 Ремонт видеонянь</h1>
            ...
            <div style='background-color: rgba(76, 175, 80, 0.1); border-left: 4px solid #4CAF50; padding: 15px; margin: 20px 0; border-radius: 0 10px 10px 0;'>
                <p style='margin: 0; font-size: 15px;'>
                    ...
                    <span style='color: #b0b0b0;'>Ремонтируем видеоняни всех брендов</span>
                </p>
            </div>
            <p style='font-size: 15px; margin: 15px 0; color: #d0d0d0;'>
                <b style='color: #4CAF50;'>Мы ремонтируем:</b> Motorola, Angelcare, Philips, Samsung, Xiaomi, Tivok, Luvion
            </p>
        </div>
        """
        self.LB1_Remont_babysitter.setText(_translate("Ui_Remont_Babysitter_Dialog", lb1_text))
        ...
        <div>
            ...
            <div style='margin: 20px 0;'>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>📱 Родительский блок</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Ремонт экрана, замена аккумулятора, восстановление звука, ремонт кнопок</p>
                </div>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>🎥 Детский блок</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Ремонт камеры, ИК-подсветки, микрофона, восстановление связи</p>
                </div>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>🔌 Электропитание</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Замена разъемов, ремонт блоков питания, восстановление зарядки</p>
                </div>
            </div>
        ...
        """
        self.LB2_Remont_babysitter.setText(_translate("Ui_Remont_Babysitter_Dialog", lb2_text))
...
if __name__ == "__main__":
    ...
    ui = Ui_Ui_Remont_Babysitter_Dialog()
    ui.setupUi(Dialog)
    Dialog.show()
    sys.exit(app.exec_())