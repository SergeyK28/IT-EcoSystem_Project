...
class Ui_Ui_Remont_Amplifier_Dialog(object):
    def setupUi(self, Ui_Remont_Amplifier_Dialog):
        self.dialog = Ui_Remont_Amplifier_Dialog

        Ui_Remont_Amplifier_Dialog.setObjectName("Ui_Remont_Amplifier_Dialog")
        Ui_Remont_Amplifier_Dialog.resize(1100, 950)
        Ui_Remont_Amplifier_Dialog.setMinimumSize(1000, 800)

        font = QFont("Segoe UI", 10)
        Ui_Remont_Amplifier_Dialog.setFont(font)

        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../Pictures/Screenshot from 2025-09-15 14-30-16.png"),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Ui_Remont_Amplifier_Dialog.setWindowIcon(icon)

        Ui_Remont_Amplifier_Dialog.setStyleSheet("""
            QDialog {
        ...
        self.main_layout = QtWidgets.QVBoxLayout(Ui_Remont_Amplifier_Dialog)
        ...
        self.page_title = QLabel("🎚️ Ремонт усилителей")
        ...
        self.page_subtitle = QLabel("Профессиональный ремонт усилителей")
        ...
        self.QW_Remont_amplifier = QWidget()
        self.QW_Remont_amplifier.setStyleSheet("background-color: transparent;")
        self.gridLayout = QtWidgets.QGridLayout(self.QW_Remont_amplifier)
        ...
        self.LB1_Remont_amplifier = QLabel()
        self.LB1_Remont_amplifier.setWordWrap(True)
        self.LB1_Remont_amplifier.setOpenExternalLinks(True)
        self.LB1_Remont_amplifier.setStyleSheet("""
            QLabel {
                color: #f0f0f0;
        ...
        """)
        info_layout.addWidget(self.LB1_Remont_amplifier)
        ...
        table_header = QLabel("💰 Стоимость ремонта усилителей")
        ...
        services_list = [
            {"name": "Ремонт блока питания", "price": "от 1500 ₽"},
            {"name": "Замена транзисторов", "price": "от 1000 ₽"},
            {"name": "Ремонт предварительного усилителя", "price": "от 1200 ₽"},
            {"name": "Замена конденсаторов", "price": "от 800 ₽"},
            {"name": "Ремонт оконечного каскада", "price": "от 1500 ₽"},
            {"name": "Замена регуляторов", "price": "от 600 ₽"},
            {"name": "Ремонт входных разъемов", "price": "от 500 ₽"},
        ...
        self.order_button = ModernButton("🎚️ Заказать ремонт усилителя")
        ...
        self.LB2_Remont_amplifier = QLabel()
        self.LB2_Remont_amplifier.setWordWrap(True)
        self.LB2_Remont_amplifier.setOpenExternalLinks(True)
        self.LB2_Remont_amplifier.setStyleSheet("""
            QLabel {
                color: #e0e0e0;
                background: transparent;
                font-size: 15px;
        ...
        """)
        detail_layout.addWidget(self.LB2_Remont_amplifier)
        ...
        self.scrollArea.setWidget(self.QW_Remont_amplifier)
        self.main_layout.addWidget(self.scrollArea)

        self.back_button.clicked.connect(Ui_Remont_Amplifier_Dialog.close)

        self.setup_favorites_button()
        self.check_favorite_status()

        self.retranslateUi(Ui_Remont_Amplifier_Dialog)
        QtCore.QMetaObject.connectSlotsByName(Ui_Remont_Amplifier_Dialog)

    def retranslateUi(self, Ui_Remont_Amplifier_Dialog):
        _translate = QtCore.QCoreApplication.translate
        Ui_Remont_Amplifier_Dialog.setWindowTitle(_translate("Ui_Remont_Amplifier_Dialog", "IT-EcoSystem - Ремонт усилителей"))

        lb1_text = """
        <div style='text-align: left;'>
            <h1 style='color: #4CAF50; font-size: 32px; margin: 0 0 20px 0;'>🎚️ Ремонт усилителей любой сложности</h1>
            <p style='font-size: 16px; margin-bottom: 20px; color: #e0e0e0;'>
                ...
                усилителей всех типов: домашних, автомобильных и профессиональных.
            </p>
            <div style='background-color: rgba(76, 175, 80, 0.1); border-left: 4px solid #4CAF50; padding: 15px; margin: 20px 0; border-radius: 0 10px 10px 0;'>
                <p style='margin: 0; font-size: 15px;'>
                    <span style='color: #4CAF50; font-weight: bold;'>✓ Профессиональный ремонт</span><br>
                    <span style='color: #b0b0b0;'>Ремонтируем усилители всех брендов</span>
                </p>
            </div>
            <p style='font-size: 15px; margin: 15px 0; color: #d0d0d0;'>
                <b style='color: #4CAF50;'>Мы ремонтируем:</b> Yamaha, Pioneer, Sony, Denon, Marantz, Onkyo, Alpine, Kicx
            </p>
        </div>
        """
        self.LB1_Remont_amplifier.setText(_translate("Ui_Remont_Amplifier_Dialog", lb1_text))
        ...
        <div>
            ...
            <div style='margin: 20px 0;'>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>🏠 Домашние усилители</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Ремонт AV-ресиверов, стереоусилителей, интегральных усилителей</p>
                </div>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>🚗 Автомобильные усилители</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Ремонт моноблоков, 2-х и 4-х канальных усилителей</p>
                </div>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>🎤 Профессиональные усилители</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Ремонт концертных усилителей, клубного оборудования</p>
                </div>
            </div>
        ...
        """
        self.LB2_Remont_amplifier.setText(_translate("Ui_Remont_Amplifier_Dialog", lb2_text))
...
if __name__ == "__main__":
    ...
    ui = Ui_Ui_Remont_Amplifier_Dialog()
    ui.setupUi(Dialog)
    Dialog.show()
    sys.exit(app.exec_())