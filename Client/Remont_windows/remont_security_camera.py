...
class Ui_Ui_Remont_SecurityCamera_Dialog(object):
    def setupUi(self, Ui_Remont_SecurityCamera_Dialog):
        self.dialog = Ui_Remont_SecurityCamera_Dialog

        Ui_Remont_SecurityCamera_Dialog.setObjectName("Ui_Remont_SecurityCamera_Dialog")
        Ui_Remont_SecurityCamera_Dialog.resize(1100, 950)
        Ui_Remont_SecurityCamera_Dialog.setMinimumSize(1000, 800)

        font = QFont("Segoe UI", 10)
        Ui_Remont_SecurityCamera_Dialog.setFont(font)

        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../Pictures/Screenshot from 2025-09-15 14-30-16.png"),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Ui_Remont_SecurityCamera_Dialog.setWindowIcon(icon)

        Ui_Remont_SecurityCamera_Dialog.setStyleSheet("""
            QDialog {
        ...
        self.main_layout = QtWidgets.QVBoxLayout(Ui_Remont_SecurityCamera_Dialog)
        ...
        self.page_title = QLabel("📹 Ремонт видеонаблюдения")
        ...
        self.page_subtitle = QLabel("Профессиональный ремонт систем видеонаблюдения")
        ...
        self.QW_Remont_security_camera = QWidget()
        self.QW_Remont_security_camera.setStyleSheet("background-color: transparent;")
        self.gridLayout = QtWidgets.QGridLayout(self.QW_Remont_security_camera)
        ...
        self.LB1_Remont_security_camera = QLabel()
        self.LB1_Remont_security_camera.setWordWrap(True)
        self.LB1_Remont_security_camera.setOpenExternalLinks(True)
        self.LB1_Remont_security_camera.setStyleSheet("""
            QLabel {
                color: #f0f0f0;
        ...
        """)
        info_layout.addWidget(self.LB1_Remont_security_camera)
        ...
        table_header = QLabel("💰 Стоимость ремонта систем видеонаблюдения")
        ...
        services_list = [
            {"name": "Ремонт камер видеонаблюдения", "price": "от 1000 ₽"},
            {"name": "Ремонт видеорегистраторов", "price": "от 1200 ₽"},
            {"name": "Настройка системы видеонаблюдения", "price": "от 1500 ₽"},
            {"name": "Замена объектива", "price": "от 800 ₽"},
            {"name": "Ремонт ИК-подсветки", "price": "от 700 ₽"},
            {"name": "Восстановление после залития", "price": "от 1200 ₽"},
            {"name": "Ремонт блока питания", "price": "от 900 ₽"},
        ...
        self.order_button = ModernButton("📹 Заказать ремонт видеонаблюдения")
        ...
        self.LB2_Remont_security_camera = QLabel()
        self.LB2_Remont_security_camera.setWordWrap(True)
        self.LB2_Remont_security_camera.setOpenExternalLinks(True)
        self.LB2_Remont_security_camera.setStyleSheet("""
            QLabel {
                color: #e0e0e0;
                background: transparent;
                font-size: 15px;
        ...
        """)
        detail_layout.addWidget(self.LB2_Remont_security_camera)
        ...
        self.scrollArea.setWidget(self.QW_Remont_security_camera)
        self.main_layout.addWidget(self.scrollArea)

        self.back_button.clicked.connect(Ui_Remont_SecurityCamera_Dialog.close)

        self.setup_favorites_button()
        self.check_favorite_status()

        self.retranslateUi(Ui_Remont_SecurityCamera_Dialog)
        QtCore.QMetaObject.connectSlotsByName(Ui_Remont_SecurityCamera_Dialog)

    def retranslateUi(self, Ui_Remont_SecurityCamera_Dialog):
        _translate = QtCore.QCoreApplication.translate
        Ui_Remont_SecurityCamera_Dialog.setWindowTitle(_translate("Ui_Remont_SecurityCamera_Dialog", "IT-EcoSystem - Ремонт видеонаблюдения"))

        lb1_text = """
        <div style='text-align: left;'>
            <h1 style='color: #4CAF50; font-size: 32px; margin: 0 0 20px 0;'>📹 Ремонт систем видеонаблюдения</h1>
            <p style='font-size: 16px; margin-bottom: 20px; color: #e0e0e0;'>
                ...
                систем видеонаблюдения любой сложности.
            </p>
            <div style='background-color: rgba(76, 175, 80, 0.1); border-left: 4px solid #4CAF50; padding: 15px; margin: 20px 0; border-radius: 0 10px 10px 0;'>
                <p style='margin: 0; font-size: 15px;'>
                    <span style='color: #4CAF50; font-weight: bold;'>✓ Полный спектр услуг</span><br>
                    <span style='color: #b0b0b0;'>Ремонт, настройка и обслуживание систем видеонаблюдения</span>
                </p>
            </div>
            <p style='font-size: 15px; margin: 15px 0; color: #d0d0d0;'>
                <b style='color: #4CAF50;'>Мы работаем с:</b> Hikvision, Dahua, Uniview, Bosh, Samsung, Sony, Axis
            </p>
        </div>
        """
        self.LB1_Remont_security_camera.setText(_translate("Ui_Remont_SecurityCamera_Dialog", lb1_text))
        ...
        <div>
            ...
            <div style='margin: 20px 0;'>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>📹 Ремонт камер</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Замена объективов, ремонт матриц, восстановление ИК-подсветки</p>
                </div>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>💾 Ремонт регистраторов</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Ремонт HDD, восстановление ПО, замена плат, ремонт блока питания</p>
                </div>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>🔧 Настройка и монтаж</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Настройка удаленного доступа, монтаж камер, прокладка кабеля</p>
                </div>
            </div>
            <div style='background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #1a3a1a, stop:1 #2a4a2a); padding: 20px; border-radius: 15px; margin: 30px 0;'>
                ...
                <table width='100%' style='color: #e0e0e0;'>
                    ...
                    <td style='padding: 5px;'>✓ <b style='color: #4CAF50;'>Срочный выезд</b></td>
                    </tr>
        ...
        """
        self.LB2_Remont_security_camera.setText(_translate("Ui_Remont_SecurityCamera_Dialog", lb2_text))
...
if __name__ == "__main__":
    ...
    ui = Ui_Ui_Remont_SecurityCamera_Dialog()
    ui.setupUi(Dialog)
    Dialog.show()
    sys.exit(app.exec_())