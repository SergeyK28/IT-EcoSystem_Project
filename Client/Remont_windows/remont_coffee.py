...
class Ui_Ui_Remont_Coffee_Dialog(object):
    def setupUi(self, Ui_Remont_Coffee_Dialog):
        self.dialog = Ui_Remont_Coffee_Dialog

        Ui_Remont_Coffee_Dialog.setObjectName("Ui_Remont_Coffee_Dialog")
        Ui_Remont_Coffee_Dialog.resize(1100, 950)
        Ui_Remont_Coffee_Dialog.setMinimumSize(1000, 800)

        font = QFont("Segoe UI", 10)
        Ui_Remont_Coffee_Dialog.setFont(font)

        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../Pictures/Screenshot from 2025-09-15 14-30-16.png"),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Ui_Remont_Coffee_Dialog.setWindowIcon(icon)

        Ui_Remont_Coffee_Dialog.setStyleSheet("""
            QDialog {
        ...
        self.main_layout = QtWidgets.QVBoxLayout(Ui_Remont_Coffee_Dialog)
        ...
        self.page_title = QLabel("☕ Ремонт кофемашин")
        ...
        self.QW_Remont_coffee = QWidget()
        self.QW_Remont_coffee.setStyleSheet("background-color: transparent;")
        self.gridLayout = QtWidgets.QGridLayout(self.QW_Remont_coffee)
        ...
        self.LB1_Remont_coffee = QLabel()
        self.LB1_Remont_coffee.setWordWrap(True)
        self.LB1_Remont_coffee.setOpenExternalLinks(True)
        self.LB1_Remont_coffee.setStyleSheet("""
            QLabel {
                color: #f0f0f0;
        ...
        """)
        info_layout.addWidget(self.LB1_Remont_coffee)
        ...
        table_header = QLabel("💰 Стоимость ремонта кофемашин")
        ...
        services_list = [
            {"name": "Чистка и декальцинация", "price": "от 1000 ₽"},
            {"name": "Ремонт помпы", "price": "от 1500 ₽"},
            {"name": "Замена нагревательного элемента", "price": "от 1800 ₽"},
            {"name": "Ремонт блока заваривания", "price": "от 1200 ₽"},
            {"name": "Замена жерновов", "price": "от 1300 ₽"},
            {"name": "Ремонт электроники", "price": "от 1500 ₽"},
            {"name": "Замена клапанов", "price": "от 1000 ₽"},
        ...
        self.order_button = ModernButton("☕ Заказать ремонт кофемашины")
        ...
        self.LB2_Remont_coffee = QLabel()
        self.LB2_Remont_coffee.setWordWrap(True)
        self.LB2_Remont_coffee.setOpenExternalLinks(True)
        self.LB2_Remont_coffee.setStyleSheet("""
            QLabel {
                color: #e0e0e0;
                background: transparent;
                font-size: 15px;
        ...
        """)
        detail_layout.addWidget(self.LB2_Remont_coffee)
        ...
        self.scrollArea.setWidget(self.QW_Remont_coffee)
        self.main_layout.addWidget(self.scrollArea)

        self.back_button.clicked.connect(Ui_Remont_Coffee_Dialog.close)

        self.setup_favorites_button()
        self.check_favorite_status()

        self.retranslateUi(Ui_Remont_Coffee_Dialog)
        QtCore.QMetaObject.connectSlotsByName(Ui_Remont_Coffee_Dialog)

    def retranslateUi(self, Ui_Remont_Coffee_Dialog):
        _translate = QtCore.QCoreApplication.translate
        Ui_Remont_Coffee_Dialog.setWindowTitle(_translate("Ui_Remont_Coffee_Dialog", "IT-EcoSystem - Ремонт кофемашин"))

        lb1_text = """
        <div style='text-align: left;'>
            <h1 style='color: #4CAF50; font-size: 32px; margin: 0 0 20px 0;'>☕ Ремонт кофемашин любой сложности</h1>
            <p style='font-size: 16px; margin-bottom: 20px; color: #e0e0e0;'>
                ...
                кофемашин всех типов: автоматических, рожковых и капсульных.
            </p>
            <div style='background-color: rgba(76, 175, 80, 0.1); border-left: 4px solid #4CAF50; padding: 15px; margin: 20px 0; border-radius: 0 10px 10px 0;'>
                <p style='margin: 0; font-size: 15px;'>
                    <span style='color: #4CAF50; font-weight: bold;'>✓ Ремонт любых кофемашин</span><br>
                    <span style='color: #b0b0b0;'>Ремонтируем кофемашины всех брендов</span>
                </p>
            </div>
            <p style='font-size: 15px; margin: 15px 0; color: #d0d0d0;'>
                <b style='color: #4CAF50;'>Мы ремонтируем:</b> Saeco, De'Longhi, Jura, Philips, Krups, Bosch, Melitta, Nivona
            </p>
        </div>
        """
        self.LB1_Remont_coffee.setText(_translate("Ui_Remont_Coffee_Dialog", lb1_text))
        ...
        <div>
            ...
            <div style='margin: 20px 0;'>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>💧 Гидравлическая система</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Ремонт помпы, клапанов, замена шлангов, устранение протечек</p>
                </div>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>⚡ Электрика</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Ремонт плат управления, замена нагревательных элементов, датчиков</p>
                </div>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>🔧 Механика</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Ремонт кофемолки, блока заваривания, замена жерновов</p>
                </div>
            </div>
            <div style='background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #1a3a1a, stop:1 #2a4a2a); padding: 20px; border-radius: 15px; margin: 30px 0;'>
                ...
                <table width='100%' style='color: #e0e0e0;'>
                    ...
                    <tr><td style='padding: 5px;'>✓ <b style='color: #4CAF50;'>Бесплатная диагностика</b></td>
                    <td style='padding: 5px;'>✓ <b style='color: #4CAF50;'>Профессиональное оборудование</b></td>
                    </tr>
                </table>
            </div>
        ...
        """
        self.LB2_Remont_coffee.setText(_translate("Ui_Remont_Coffee_Dialog", lb2_text))
