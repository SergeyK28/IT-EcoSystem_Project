...
class Ui_Ui_Remont_DVR_Dialog(object):
    def setupUi(self, Ui_Remont_DVR_Dialog):
        self.dialog = Ui_Remont_DVR_Dialog

        Ui_Remont_DVR_Dialog.setObjectName("Ui_Remont_DVR_Dialog")
        Ui_Remont_DVR_Dialog.resize(1100, 950)
        Ui_Remont_DVR_Dialog.setMinimumSize(1000, 800)

        font = QFont("Segoe UI", 10)
        Ui_Remont_DVR_Dialog.setFont(font)

        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../Pictures/Screenshot from 2025-09-15 14-30-16.png"),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Ui_Remont_DVR_Dialog.setWindowIcon(icon)

        Ui_Remont_DVR_Dialog.setStyleSheet("""
            QDialog {
        ...
        self.main_layout = QtWidgets.QVBoxLayout(Ui_Remont_DVR_Dialog)
        ...
        self.page_title = QLabel("📼 Ремонт видеорегистраторов")
        ...
        self.page_subtitle = QLabel("Профессиональный ремонт видеорегистраторов")
        ...
        self.QW_Remont_dvr = QWidget()
        self.QW_Remont_dvr.setStyleSheet("background-color: transparent;")
        self.gridLayout = QtWidgets.QGridLayout(self.QW_Remont_dvr)
        ...
        self.LB1_Remont_dvr = QLabel()
        self.LB1_Remont_dvr.setWordWrap(True)
        self.LB1_Remont_dvr.setOpenExternalLinks(True)
        self.LB1_Remont_dvr.setStyleSheet("""
            QLabel {
                color: #f0f0f0;
        ...
        """)
        info_layout.addWidget(self.LB1_Remont_dvr)
        ...
        table_header = QLabel("💰 Стоимость ремонта видеорегистраторов")
        ...
        services_list = [
            ...
            {"name": "Замена экрана", "price": "от 1000 ₽"},
            {"name": "Ремонт объектива", "price": "от 800 ₽"},
            {"name": "Замена аккумулятора", "price": "от 700 ₽"},
            {"name": "Ремонт разъема питания", "price": "от 500 ₽"},
            {"name": "Восстановление прошивки", "price": "от 600 ₽"},
            {"name": "Замена кнопок", "price": "от 500 ₽"},
        ...
        self.order_button = ModernButton("📼 Заказать ремонт видеорегистратора")
        ...
        self.LB2_Remont_dvr = QLabel()
        self.LB2_Remont_dvr.setWordWrap(True)
        self.LB2_Remont_dvr.setOpenExternalLinks(True)
        self.LB2_Remont_dvr.setStyleSheet("""
            QLabel {
                color: #e0e0e0;
                background: transparent;
                font-size: 15px;
        ...
        """)
        detail_layout.addWidget(self.LB2_Remont_dvr)
        ...
        self.scrollArea.setWidget(self.QW_Remont_dvr)
        self.main_layout.addWidget(self.scrollArea)

        self.back_button.clicked.connect(Ui_Remont_DVR_Dialog.close)

        self.setup_favorites_button()
        self.check_favorite_status()

        self.retranslateUi(Ui_Remont_DVR_Dialog)
        QtCore.QMetaObject.connectSlotsByName(Ui_Remont_DVR_Dialog)

    def retranslateUi(self, Ui_Remont_DVR_Dialog):
        _translate = QtCore.QCoreApplication.translate
        Ui_Remont_DVR_Dialog.setWindowTitle(_translate("Ui_Remont_DVR_Dialog", "IT-EcoSystem - Ремонт видеорегистраторов"))

        lb1_text = """
        <div style='text-align: left;'>
            <h1 style='color: #4CAF50; font-size: 32px; margin: 0 0 20px 0;'>📼 Ремонт видеорегистраторов</h1>
            ...
            <div style='background-color: rgba(76, 175, 80, 0.1); border-left: 4px solid #4CAF50; padding: 15px; margin: 20px 0; border-radius: 0 10px 10px 0;'>
                <p style='margin: 0; font-size: 15px;'>
                    ...
                    <span style='color: #b0b0b0;'>Ремонтируем видеорегистраторы всех брендов</span>
                </p>
            </div>
            <p style='font-size: 15px; margin: 15px 0; color: #d0d0d0;'>
                <b style='color: #4CAF50;'>Мы ремонтируем:</b> Xiaomi, BlackVue, Garmin, DOD, StreetStorm, Artway, TrendVision
            </p>
        </div>
        """
        self.LB1_Remont_dvr.setText(_translate("Ui_Remont_DVR_Dialog", lb1_text))
        ...
        <div>
            ...
            <div style='margin: 20px 0;'>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    ...
                    <p style='color: #b0b0b0; margin: 0;'>Ремонт материнских плат, замена процессора, восстановление памяти</p>
                </div>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>📷 Оптика и экран</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Замена объектива, ремонт дисплея, замена стекла</p>
                </div>
                <div style='margin-bottom: 15px; padding: 20px; background-color: #2d2d2d; border-radius: 15px; border-left: 4px solid #4CAF50;'>
                    <h3 style='color: #4CAF50; margin: 0 0 10px 0;'>⚡ Питание</h3>
                    <p style='color: #b0b0b0; margin: 0;'>Ремонт разъемов, замена аккумуляторов, восстановление прикуривателя</p>
                </div>
            </div>
        ...
        """
        self.LB2_Remont_dvr.setText(_translate("Ui_Remont_DVR_Dialog", lb2_text))
